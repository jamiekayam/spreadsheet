                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            Column A
                            <br />
                            <button type="button" id="buttonCreateColumnLeftA">CREATE New Column on Left</button>
                            <button type="button" id="buttonCreateColumnRightA">CREATE New Column on RIGHT</button>

                            <button type="button" id="buttonMoveColumnLeftA">MOVE this Column LEFT</button>
                            <button type="button" id="buttonMoveColumnRightA">MOVE this Column RIGHT</button>

                            <button type="button" id="buttonDeleteColumnA">DELETE This Column</button>
                        </th>
                    </tr>
                </thead>
                <tbody>
